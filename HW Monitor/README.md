...
* Anpassungen am Code da sich die Variablen zeitweise neu erstellen und somit die ID ändert. Die ergab Probleme bei aufgezeichneten und visualisierten Variablen
